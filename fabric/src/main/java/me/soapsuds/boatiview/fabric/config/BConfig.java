...
public class BConfig extends PartitioningSerializer.GlobalData {
    ...
    @ConfigEntry.Category(BConstants.CONFIG_NAME_CLOTH_CONFIG)
    @ConfigEntry.Gui.TransitiveObject
    public BClientConfig clientConfig = new BClientConfig();

    @Config(name = BConstants.CONFIG_NAME_CLOTH_CONFIG)
    public static class BClientConfig implements ConfigData {
