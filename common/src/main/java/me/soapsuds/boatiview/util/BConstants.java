...
public class BConstants {
	...
	public static final String CLOTH_CONFIG_MODID = "cloth_config"; //1.14 to 1.17 = cloth-config2. 1.18+ = cloth_config
	 ...
	 * Config Option Translation Key = "text.autoconfig.boatiview_fabric.my_config_option"
	 ...
	 * Config Option Translation Key = "text.autoconfig.client.my_config_option"
	 */
